            ...
            <div>
                ...
                <div className="flex flex-col md:flex-row gap-4 text-indigo-950 select-none">
                    <div className="grow ring-1 ring-gray-300 p-6 rounded-2xl shadow-md hover:translate-y-[-0.5rem] transition-all bg-gray-50">
                        ...
                        <button className="hover:gap-4 transition-all flex items-center gap-2">
                            <span>Scopri di più</span>
                            <FaArrowRightLong />
                        </button>
                    </div>

                    <div className="gZrow bg-indigo-600 p-6 rounded-2xl shadow-md text-gray-50 hover:translate-y-[-0.5rem] transition-all">
